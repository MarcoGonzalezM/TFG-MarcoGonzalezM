...
class Model_TrainTest:
    def __init__(self, hyperparams):
        ...
        # self.env = gym.make('Taxi-v3', max_episode_steps=self.max_steps,
        #                    render_mode="human" if self.render else None)
    ...
    def plot_training(self, episode):
        ...
        plt.plot(self.agent.loss_history, label='Loss (MSE)', color='#8549f2', alpha=1)
        plt.xlabel("Episode")
        plt.ylabel("Loss")
...
if __name__ == '__main__':
    # Parameters:
    train_mode = True # Set to True for training, False for testing
    ...
    RL_hyperparams = {
        ...
        "batch_size"            : 32,
        "update_frequency"      : 40,
        "max_episodes"          : 600           if train_mode else 2,
        "max_steps"             : 200,
        "render"                : render,
...
"""@misc{DQN-Cliff-Walking-Gymnasium,
    author       = {Mehdi Shahbazi Khojasteh},
    title        = {DQN-Cliff-Walking-Gymnasium},
    url          = {https://github.com/MehdiShahbazi/DQN-Cliff-Walking-Gymnasium}
}"""